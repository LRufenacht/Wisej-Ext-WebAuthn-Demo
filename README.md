...
<div align="center">
  ...
  <h3 align="center">Wisej.NET Web Authentication API (WebAuthn) Demo</h3>
...
3) Performs basic validation on the client credentials.

The source code for Wisej-Ext-WebAuthn can be found here:
